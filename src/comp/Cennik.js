...
const Cennik = () => {
  return (
    <div className='w-full h-auto mb-20'>
      ...
      <div name="cennik" className='max-w-6xl m-auto grid grid-cols-2 md:grid-cols-3'>
        <div className='h-max-24 md:m-12 mx-4 my-6 sm:my-4 rounded-lg flex flex-col justify-between cena border-2 border-black'>
          ...
          <div className='w-full flex flex-col text-center pb-3'>
            ...
            <p className='md:text-2xl text-xl'>Cena: <span className='font-bold'>45€</span></p>
          </div>
        </div>
        <div className='h-max-24 md:m-12 mx-4 my-6 sm:my-4 rounded-lg flex flex-col justify-between cena border-2 border-black'>
          <div className='w-full md:text-xl text-lg p-4'>Tepovanie</div>
          ...
          <div className='w-full flex flex-col text-center pb-3'>
            ...
            <p className='md:text-2xl text-xl'>Cena: <span className='font-bold'>10€</span></p>
          </div>
        </div>
        <div className='h-max-24 md:m-12 mx-4 my-6 sm:my-4 rounded-lg flex flex-col justify-between cena border-2 border-black'>
          <div className='w-full md:text-xl text-lg p-4'>Tepovanie</div>
          ...
          <div className='w-full flex flex-col text-center pb-3'>
            ...
            <p className='md:text-2xl text-xl'>Cena: <span className='font-bold'>50€</span></p>
          </div>
        </div>
        <div className='h-max-24 md:m-12 mx-4 my-6 sm:my-4 rounded-lg flex flex-col justify-between cena border-2 border-black'>
         <div className='w-full  md:text-xl text-lg p-4'>Tepovanie</div>
         <img alt='/' src={vankus} className='md:w-[95px] w-[75px] m-auto mb-4'></img>
          <div className='w-full flex flex-col text-center pb-3'>
            ...
            <p className='md:text-2xl text-xl'>Cena: od <span className='font-bold'>3€</span></p>
          </div>
        </div>
        <div className='h-max-24 md:m-12 mx-4 my-6 sm:my-4 rounded-lg flex flex-col justify-between cena border-2 border-black'>
          <div className='w-full md:text-xl text-lg p-4'>Tepovanie</div>
          ...
          <div className='w-full flex flex-col text-center pb-3'>
            ...
            <p className='md:text-2xl text-xl'>Cena: <span className='font-bold'>25€</span></p>
          </div>
        </div>
        <div className='h-max-24 md:m-12 mx-4 my-6 sm:my-4 rounded-lg flex flex-col justify-between cena border-2 border-black'>
          <div className='w-full md:text-xl text-lg p-4'>Tepovanie</div>
